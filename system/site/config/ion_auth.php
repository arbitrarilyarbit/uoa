...
*/
	 ...
	 * Tables.
	 **/
	$config['tables']['groups']  = 'uoa_groups';
	$config['tables']['users']   = 'uoa_users';
	$config['tables']['meta']    = 'uoa_meta';
	
	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = "UoA"; //TODO: update this
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "admin@example.com"; //TODO: update this
	
	/**
	 * Default group, use name
	 */
	$config['default_group']       = 'applicant';
